...
public class SessionEvent {
    ...
    private SessionEvent(SessionEventType sessionEventType, Long sessionId, String reason, String serverMessage) {
        this.sessionEventType = sessionEventType;
        this.sessionId = sessionId;
        this.reason = reason;
        this.serverMessage = serverMessage;
    ...
    public static SessionEvent sessionStarted(Long sessionId, String reason, String serverWelcomeMessage) {
        return new SessionEvent(SessionEventType.SESSION_STARTED, sessionId, reason, serverWelcomeMessage);
    }
